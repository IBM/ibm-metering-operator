...
#---------------------------------------------------------
# update the CR yaml files
#---------------------------------------------------------
echo -e "\n[INFO] Updating 'version' in CR yamls"
$SED -e "s|version: \"${LAST_CSV_VERSION}\"|version: \"${NEW_CSV_VERSION}\"|" -i "${DEPLOY_DIR}/crds/operator.ibm.com_v1alpha1_metering_cr.yaml"
$SED -e "s|version: \"${LAST_CSV_VERSION}\"|version: \"${NEW_CSV_VERSION}\"|" -i "${DEPLOY_DIR}/crds/operator.ibm.com_v1alpha1_meteringui_cr.yaml"
$SED -e "s|version: \"${LAST_CSV_VERSION}\"|version: \"${NEW_CSV_VERSION}\"|" -i "${DEPLOY_DIR}/crds/operator.ibm.com_v1alpha1_meteringmulticloudui_cr.yaml"
$SED -e "s|version: \"${LAST_CSV_VERSION}\"|version: \"${NEW_CSV_VERSION}\"|" -i "${DEPLOY_DIR}/crds/operator.ibm.com_v1alpha1_meteringsender_cr.yaml"
$SED -e "s|version: \"${LAST_CSV_VERSION}\"|version: \"${NEW_CSV_VERSION}\"|" -i "${DEPLOY_DIR}/crds/operator.ibm.com_v1alpha1_meteringreportserver_cr.yaml"
